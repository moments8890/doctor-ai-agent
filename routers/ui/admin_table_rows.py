...
async def _rows_session_states(db, doctor_id: Optional[str], limit: int, offset: int) -> list:
...
async def _fetch_table_rows(
    ...
    if table_key == "doctor_session_states":
        return await _rows_session_states(db, doctor_id, limit, offset)
