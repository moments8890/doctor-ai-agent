...
| After any change to hero path (intake, review, reply) | [`hero-path-qa-plan.md`](hero-path-qa-plan.md) | ~45 min |
...
| [`hero-path-qa-plan.md`](hero-path-qa-plan.md) | Broad reference: full doctor + patient hero path. Login → intake → diagnosis review → draft reply → send. Source of the BUG-01..07 registry. | Major releases |
...
| BUG-03 | P1 | Intake send crashes headless Playwright — needs real-device verify |
