...
Usage:
    python tools/db_inspect.py patients          # list all patients
    python tools/db_inspect.py patients doc_001  # list patients for one doctor
    python tools/db_inspect.py records           # list recent records (all doctors)
    python tools/db_inspect.py records doc_001   # records for one doctor
    python tools/db_inspect.py record 42         # full detail for one record
    python tools/db_inspect.py patient 7         # full detail for one patient + records
"""
import sqlite3
import sys
import textwrap
