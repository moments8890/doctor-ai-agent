...
from .doctor_interview_shared import (  # noqa: F401  (re-exported for backwards compat)
...
from . import doctor_interview_turn as _turn_mod
from . import doctor_interview_confirm as _confirm_mod
