...
from channels.web.doctor_dashboard.pagination import encode_cursor, decode_cursor
...
async def _fetch_records_for_patient(
    db, doctor_id: str, patient_id: int, limit: int,
...
async def manage_patients_grouped_for_doctor(db, doctor_id: str) -> dict:
...
async def manage_records_for_doctor(
    ...
    *,
    ...
    if patient_id is not None:
        ...
        items, _ = await _fetch_records_for_patient(db, doctor_id, patient_id, limit)
        total = len(items)
    else:
