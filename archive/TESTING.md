...
**验证**
```bash
python tools/db_inspect.py patient 1  # 替换为李明的 id
```
...
# CLI 快查
python tools/db_inspect.py patients          # 所有患者
python tools/db_inspect.py records           # 最近10条病历
python tools/db_inspect.py patient <id>      # 指定患者详情
python tools/db_inspect.py record <id>       # 指定病历详情
