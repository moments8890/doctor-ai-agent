"""Intake turn module — verify key exports still exist."""


def test_intake_turn_exports_field_labels():
    from domain.patients.intake_turn import FIELD_LABELS
    assert "chief_complaint" in FIELD_LABELS
    assert "present_illness" in FIELD_LABELS


def test_intake_turn_exports_build_progress():
