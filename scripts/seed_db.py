...
Usage:
    ...
    python scripts/seed_db.py --reset --no-import       # wipe only
    python scripts/seed_db.py --export --dry-run        # preview without writing

NOTE: tests/fixtures/seed_data.json may contain real patient data.  Review before committing.
...
DEFAULT_FIXTURE = ROOT / "tests" / "fixtures" / "seed_data.json"
FIXTURE_VERSION = 1
