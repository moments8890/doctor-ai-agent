...
from e2e.fixtures.scripts._generate_v2_phrase_bank import gen_unique_names
from e2e.fixtures.scripts._generate_v2_templates_af import (
    tmpl_stroke,
    tmpl_discharge,
    tmpl_chronic,
    tmpl_postop,
...
from e2e.fixtures.scripts._generate_v2_templates_gj import (
    tmpl_arrhythmia,
    tmpl_sepsis,
    tmpl_renal,
    tmpl_mental,
